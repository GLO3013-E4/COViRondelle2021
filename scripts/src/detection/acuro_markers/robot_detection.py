...
class RobotDetection(ArucoMarkers):
    ...
    def detect_obstacle(self, image, DEBUG=True):
        ...
        if len(corners) > 0:
            ...
            for (markerCorner, markerID) in zip(corners, ids):
                ...
                self.generate_robot_position(bottom_left_position, bottom_right_position, center_x, center_y,
    ...
    def generate_robot_position(self, bottom_left_position, bottom_right_position, center_x, center_y, robot_position,
